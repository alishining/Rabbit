...
var sql = {
	...
	student_sport_report : 'select distinct a.student_number, a.student_id, a.student_name, a.sex, b.item_id, b.item, b.record, b.score, b.level from student_info a left outer join report b on a.student_id = b.student_id and b.item_id in (?) and a.sex like ? and b.class_id=? and b.year=? and b.term=? and a.school_id=? where b.student_id is not null order by student_id,item_id',
