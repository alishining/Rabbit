...
var sql = {
	...
	get_school : 'select * from school where province like ? and city like ? and district like ? and school like ? and is_delete=0 order by id desc',
	...
	get_proxy_list : 'select  a.*, case when b.id is null then count(*)-1 else count(*) end as count from proxy a left outer join school b on a.id=b.proxy and b.id is not null where a.province like ? and a.city like ? and a.district like ? and a.name like ? group by a.id order by id desc',
