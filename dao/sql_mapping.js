...
var sql = {
	...
	class_level_chart : 'select b.level, a.sex, a.student_name from student_info a left outer join report b on a.student_id = b.student_id where b.year=? and b.term=? and a.class_id=? and b.item_id=? and a.school_id=? and b.student_id is not null',
