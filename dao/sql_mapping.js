...
var sql = {
	...
	record_training_item : 'update training_record set score=? where student_id=? and item=? and ds=?',
	get_daily_detail : 'select item, score from training_record where ds=? and student_id=?',
	et_training_rate : ''
};
