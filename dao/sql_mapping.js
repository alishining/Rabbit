...
var sql = {
	...
	search_student : 'SELECT * FROM student_info where school_id = ? and is_delete = \'0\' and (student_name like ? or student_id like ?) and grade like ? and class like ?',
	...
	add_report : 'insert into report(student_id,sex,class_id,item_id,item,health_item,record,unit,score,level,year,term) values ?',
