...
var sql = {
	...
	get_school_from_proxy : 'select a.*, b.name as manager_name from (select a.*, b.name from school a left outer join proxy b on a.proxy =b.id where a.proxy=?) a left outer join manager b on a.manager = b.id',
